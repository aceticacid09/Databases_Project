...
<?php 
    ...
    if(isset($_REQUEST['submit'])) {
        ...
        if (empty($name)) {
            ...
            try {
                if (!isset($errorMsg)) {
                    $insert_stmt = $db->prepare("INSERT INTO employee(name,lastname,edulev) VALUES (:n, :a, :p)");
                    $insert_stmt -> bindParam(':n', $name);
                    $insert_stmt -> bindParam(':a', $lastname);
                    $insert_stmt -> bindParam(':p', $edulev);
    
                    if($insert_stmt->execute()) {
                        $insertMsg = "Insert Successfully...";
                        header("refresh:2;apply.php");
                    }
                }
...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8" />
    <title>want to working with us?</title>
  ...
  <body>
    <video id="background-video" autoplay loop muted>
        <source src="/webDB/video/shakehand_hd50fps.mp4" type="video/mp4">
      </video>
    ...
    <div class="container">
      <div class="title">Registration your info</div>
      <div class="content">
        <form action="#">
          <div class="user-details">
            ...
            <div class="input-box">
              ...
              <input type="text" name="txt_lastname" placeholder="Enter your last name" required />
            </div>
            <div class="input-box">
              <span class="details">Education level</span>
              <input type="text" name="txt_edu" placeholder="Enter your education level" required />
            </div>
            <div class="input-box">
