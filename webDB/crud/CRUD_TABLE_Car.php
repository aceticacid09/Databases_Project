<?php 
    ...
    if(isset($_REQUEST['delete_Car_ID'])) {
        ...
        $delete_stmt = $db->prepare('DELETE FROM car WHERE Car_ID = :c');
        $delete_stmt->bindParam(':c', $Car_ID);
        $delete_stmt->execute();

        header('Location:CRUD_TABLE_Car.php');
    } 
?>
			...
			<form>
				...
				<div class="modal-body">					
					<div class="form-group">
						<label>Car_ID</label>
						<input type="text" name="txt_Car_ID" class="form-control" required></input>
					</div>
					<div class="form-group">
